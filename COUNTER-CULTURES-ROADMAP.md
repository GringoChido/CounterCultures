...
| P1.6 | **Trade Program — kill hardcoded mocks, wire real data** | [`docs/fixes/p1-trade-program-real-data.md`](docs/fixes/p1-trade-program-real-data.md) | 🟢 DONE 2026-05-14 | 1 day |
