...
|---|---|---|---|
| Wed–Thu | **Search platform migration** (Algolia / Meili / Typesense, feature-flagged, smoke-loop verified) | 2 days | *(was B9)* Highest blast radius. Flag-gated tail may spill to Fri/Week 3 safely. **The remaining Week-2 anchor now that Hub + Nav shipped.** |
