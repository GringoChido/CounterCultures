  ...
  return (
    <div className="quote-doc max-w-[800px] mx-auto bg-white p-10 print:p-0 shadow-sm text-[#2C2C2C] font-['DM_Sans',sans-serif] text-sm leading-relaxed">
      ...
      {customerFacing && depositPayUrl && grandTotal > 0 && (
        <div className="no-print mb-8 p-5 bg-[#B87333]/5 border border-[#B87333]/20 rounded">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-6 py-3 bg-[#B87333] text-white rounded-lg font-semibold text-sm hover:bg-[#A66628] transition-colors whitespace-nowrap"
            >
