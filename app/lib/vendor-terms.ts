...
const SEED_VENDORS: VendorTerms[] = [
  ...
  },
  {
    ...
    notes: "[seed — edit in sheet] Invoices off PO confirmation. Good docs, slower lead times on custom finishes.",
  },
  {
    vendor: "toto_usa",
    name: "TOTO USA",
    ...
    notes: "[seed — edit in sheet] Ships from US warehouse. Neorest lines can run 12–14 weeks.",
  },
  {
    vendor: "brizo_delta",
    name: "Brizo / Delta Faucet",
    creditTerms: "net 30",
    termDays: 30,
    billingTrigger: "on-ship",
    confirmationPattern: "sends-confirmation",
    defaultLeadTimeDays: 32,
    notes: "[seed — edit in sheet] Ships via Ferguson or direct. Confirmation includes estimated ship date.",
  },
  {
    vendor: "kohler_direct",
    name: "Kohler Co. (direct)",
    creditTerms: "split 50/50",
    termDays: 15,
    billingTrigger: "split-50-50",
    confirmationPattern: "sends-confirmation",
    defaultLeadTimeDays: 28,
    notes: "[seed — edit in sheet] Direct orders on custom/Artist Edition. 50% deposit, 50% net 15 from ship.",
  },
  {
    vendor: "badeloft",
    name: "Badeloft",
    ...
    notes: "[seed — edit in sheet] Freestanding tubs. Full payment before production starts.",
  },
];
