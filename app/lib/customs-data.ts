...
> = {
  "collecting":          { label: { en: "Collecting",         es: "Recopilando" },          bg: "bg-dash-text-muted/10",    text: "text-dash-text-muted",    step: 1 },
  "sent-to-broker":      { label: { en: "Sent to Broker",     es: "Enviado al Agente" },    bg: "bg-dash-info/10",    text: "text-dash-info",    step: 2 },
  "at-warehouse":        { label: { en: "At Warehouse",       es: "En Bodega" },            bg: "bg-dash-info/10",    text: "text-dash-info",    step: 3 },
  "import-open":         { label: { en: "Import Open",        es: "Importación Abierta" },  bg: "bg-dash-info/10",  text: "text-dash-info",  step: 4 },
  "awaiting-documents":  { label: { en: "Awaiting Documents", es: "Esperando Documentos" }, bg: "bg-dash-warn/10",   text: "text-dash-warn",   step: 5 },
  "import-closed":       { label: { en: "Import Closed",      es: "Importación Cerrada" },  bg: "bg-dash-cat-violet/10",  text: "text-dash-cat-violet",  step: 6 },
  "calculo-received":    { label: { en: "Cálculo Received",   es: "Cálculo Recibido" },     bg: "bg-dash-warn/10",  text: "text-dash-warn",  step: 7 },
  "payment-pending":     { label: { en: "Payment Pending",    es: "Pago Pendiente" },       bg: "bg-dash-warn/10",   text: "text-dash-warn",   step: 8 },
  "payment-sent":        { label: { en: "Payment Sent",       es: "Pago Enviado" },         bg: "bg-dash-info/10",    text: "text-dash-info",    step: 9 },
  "crossing-approved":   { label: { en: "Crossing Approved",  es: "Cruce Aprobado" },       bg: "bg-dash-cat-teal/10",    text: "text-dash-cat-teal",    step: 10 },
  "in-transit-domestic": { label: { en: "In Transit (MX)",    es: "En Tránsito (MX)" },     bg: "bg-dash-info/10",    text: "text-dash-info",    step: 11 },
  "delivered-to-cc":     { label: { en: "Delivered to CC",    es: "Entregado en CC" },       bg: "bg-dash-cat-teal/10",    text: "text-dash-cat-teal",    step: 12 },
  "factura-received":    { label: { en: "Factura Received",   es: "Factura Recibida" },      bg: "bg-dash-success/10", text: "text-dash-success", step: 13 },
  "expediente-pending":  { label: { en: "Expediente Pending", es: "Expediente Pendiente" },  bg: "bg-dash-cat-lime/10",    text: "text-dash-cat-lime",    step: 14 },
  "complete":            { label: { en: "Complete",           es: "Completo" },              bg: "bg-dash-success/10",   text: "text-dash-success",   step: 15 },
  "issue":               { label: { en: "Issue",              es: "Problema" },              bg: "bg-dash-danger/10",     text: "text-dash-danger",     step: 0 },
};
