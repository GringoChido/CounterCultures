...
const ODOO_URL = odooCreateUrl("sale.order");
    ...
    <div className="p-6 max-w-2xl mx-auto text-center">
      ...
      <div className="bg-dash-surface border border-dash-border rounded-lg p-8">
        <h1 className="font-display text-2xl text-dash-text mb-3">
          Create quotes in Odoo
        </h1>
        <p className="text-sm text-dash-text-secondary mb-6 max-w-md mx-auto">
          Quotes are now created directly in Odoo, where you have full access to
          customer lookup, product catalog, pricing, discounts, and terms.
        </p>
        <a
          href={ODOO_URL}
          target="_blank"
